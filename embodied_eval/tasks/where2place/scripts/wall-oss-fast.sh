...
python -m embodied_eval \
  ...
  --batch_size 1 \
  --output_path /your/path/to/embodied-eval-main/logs/where2place/wall-oss-fast \
  2>&1 | tee /your/path/to/embodied-eval-main/embodied_eval/tasks/where2place/debug_run.log