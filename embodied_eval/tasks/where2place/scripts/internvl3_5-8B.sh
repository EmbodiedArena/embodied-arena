...
CUDA_VISIBLE_DEVICES=3 accelerate launch --num_processes=1 --main_process_port=$PORT -m embodied_eval \
    --model internvl3_5 \
    --model_args model_name_or_path=/your/path/to/embodied-eval-main/embodied_eval/data/InternVL3_5-8B,max_num_frames=32,fps=8 \
    --evaluator eqa \
    --tasks where2place-point \
    --batch_size 2 \
    --output_path ./logs/where2place/internvl3_5