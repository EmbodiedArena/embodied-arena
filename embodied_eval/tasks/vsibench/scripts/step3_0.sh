...
CUDA_VISIBLE_DEVICES=2 python -m embodied_eval \
  --model step3_vl \
  --model_args model_name_or_path=/your/path/to/embodied-eval-main/embodied_eval/data/Step3-VL-10B,max_num_frames=32,device_map="auto" \
  --evaluator eqa \
  --tasks vsibench \
  --batch_size 1 \
  --limit 1 \
  --output_path /your/path/to/embodied-eval-main/logs/vsibench/step3 \
