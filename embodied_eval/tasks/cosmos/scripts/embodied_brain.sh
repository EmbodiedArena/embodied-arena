#!/bin/bash
# Cosmos Reasoning Benchmark - EmbodiedBrain-7B 评估脚本
...
# 模型配置
MODEL_PATH="/your/path/to/embodied-eval-main/embodied_eval/data/EmbodiedBrain-7B"
MODEL_TYPE="embodied_brain"
OUTPUT_BASE="./logs/cosmos/embodied_brain"

# 任务列表
TASKS=("bridgev2" "robovqa" "agibot" "holoassist" "robofail")

echo "================================"
echo "Cosmos - EmbodiedBrain-7B 评估"
echo "================================"
echo "模型: $MODEL_PATH"
echo "GPU: $GPUS"
echo "================================"
