#!/bin/bash
# Cosmos Reasoning Benchmark - Embodied-VLM 评估脚本
...
# 模型配置
MODEL_PATH="IffYuan/Embodied-VLM-8B-RFT-0307"
MODEL_TYPE="embodied_vlm"
OUTPUT_BASE="./logs/cosmos/embodied_vlm"

# 任务列表
TASKS=("bridgev2" "robovqa" "agibot" "holoassist" "robofail")

echo "================================"
echo "Cosmos - Embodied-VLM 评估"
echo "================================"
echo "模型: $MODEL_PATH"
echo "GPU: $GPUS"
echo "================================"
