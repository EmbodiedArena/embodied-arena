#!/bin/bash
# Cosmos Reasoning Benchmark - Thinker-VL-4B 评估脚本
...
# 模型配置（对齐 erqa 的 Thinker-VL 设置）
MODEL_TYPE="thinker_vl"
MODEL_ARGS="model_name_or_path=UBTECH-Robotics/Thinker-4B,max_num_frames=8"
OUTPUT_BASE="./logs/cosmos/thinker_vl_4b"

# 任务列表
TASKS=("bridgev2" "robovqa" "agibot" "holoassist" "robofail")

echo "================================"
echo "Cosmos - Thinker-VL-4B 评估"
echo "================================"
echo "模型: $MODEL_TYPE ($MODEL_ARGS)"
echo "GPU: $GPUS"
echo "================================"
echo ""
