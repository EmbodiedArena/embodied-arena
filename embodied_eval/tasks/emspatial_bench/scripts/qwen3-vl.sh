...
# 设置模型参数
MODEL_NAME="qwen3_vl"
MODEL_PATH="/your/path/to/embodied-eval-main/embodied_eval/data/Qwen3-VL-8B-Instruct"
...
CUDA_VISIBLE_DEVICES=6 accelerate launch --num_processes=1  --main_process_port=$PORT -m embodied_eval \
    ...
    --batch_size 4 \
    --output_path /your/path/to/embodied-eval-main/logs/emspatial-bench/qwen3-vl-8b-instruct
