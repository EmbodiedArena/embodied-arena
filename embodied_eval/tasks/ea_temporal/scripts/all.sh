...
#     --tasks ea-temporal \
#     --batch_size 1 \
#     --output_path /your/path/to/embodied-eval-main/logs/ea-temporal/internvl3_5-8B
...
#     --tasks ea-temporal \
#     --batch_size 1 \
#     --output_path /your/path/to/embodied-eval-main/logs/ea-temporal/embodied_brain
...
#     --tasks ea-temporal \
#     --batch_size 1 \
#     --output_path /your/path/to/embodied-eval-main/logs/ea-temporal/qwen3_vl
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --num_processes=8 --main_process_port=$PORT -m embodied_eval \
    ...
    --tasks ea-temporal \
    --batch_size 1 \
    --output_path /your/path/to/embodied-eval-main/logs/ea-temporal/cambrain