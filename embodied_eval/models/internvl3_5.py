...
class InternVL3_5(BaseAPIModel):
    """
    InternVL3.5-8B Model
    "https://huggingface.co/OpenGVLab/InternVL3_5-8B"
    """

    def __init__(
            self,
            model_name_or_path: str = "OpenGVLab/InternVL3_5-8B",
        ...
        # Load model
        eval_logger.info(f"Loading InternVL3.5-8B model from {model_name_or_path}")
        ...
        # Handle distributed setup first
        ...
        if is_local_path:
            # Local path - use local_files_only=True to avoid HF Hub validation
