...
@register_model("vebrain")
class VeBrain(BaseAPIModel):
    """
    VeBrain Model
    "https://huggingface.co/OpenGVLab/VeBrain"
    """

    def __init__(
            self,
            model_name_or_path: str = "OpenGVLab/VeBrain",
        ...
        # Load model
        eval_logger.info(f"Loading VeBrain model from {model_name_or_path}")
